...
/** @var $id */
/** @var common\modules\blog\models\TagsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'برچسب ها');
...
<div class="tags-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'افزودن برچسب'), ['create', 'article_id' => $id], ['class' => 'btn btn-success']) ?>
    </p>
