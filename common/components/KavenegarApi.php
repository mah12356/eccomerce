...
use common\components\Exceptions\HttpException;
use common\components\Exceptions\RuntimeException;
use common\components\Enums\ApiLogs ;
use common\components\Enums\General;
...
class KavenegarApi
{
    ...
    public function VerifyLookup($receptor,$template, $token, $token2, $token3,  $type = null)
    {
